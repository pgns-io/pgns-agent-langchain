...
Core library files (`pgns_agent_langchain/`, `pyproject.toml`, etc.) are synced from an upstream monorepo. PRs that modify these files can't be merged directly because the next sync would overwrite them.
